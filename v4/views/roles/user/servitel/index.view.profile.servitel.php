...
<body>
    <div class="container mt-5">
        ...
        <div class="card mx-auto" style="max-width: 1000px;">
            <div class="card-header text-center" style="background: linear-gradient(to right, #001f94, #fe6902);">
                <h4 class="text-white">Perfil de Usuario (<?php echo ($_SESSION['empresa_id'] == 1) ? 'Servientrega' : ($_SESSION['empresa_id'] == 2 ? 'Servitel' : ($_SESSION['empresa_id'] == 3 ? 'Global' : 'Empresa desconocida')); ?>)</h4>
            </div>
            <div class="card-body">
