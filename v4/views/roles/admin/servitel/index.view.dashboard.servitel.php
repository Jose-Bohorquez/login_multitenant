...
<nav class="navbar navbar-expand-lg" style="background: linear-gradient(to right, #001f94, #fe6902);">
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 p-4">
            ...
            <p>Aquí puedes ver las estadísticas y gestionar la aplicación de Servitel.</p>
...
<footer class="text-white text-center py-3 mt-5" style="background: linear-gradient(to right, #001f94, #fe6902);">
