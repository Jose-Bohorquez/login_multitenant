...
<head>
    ...
    <title>Dashboard Servientrega</title>
    <!-- Incluir Bootstrap 5 -->
...
<nav class="navbar navbar-expand-lg" style="background: #56c271;">
    <div class="container-fluid">
        <a class="text-white navbar-brand" href="#">Dashboard Servientrega</a>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 p-4">
            <h1>Bienvenido al Dashboard de Servientrega</h1>
...
<footer class="text-white text-center py-3 mt-5" style="background: #56c271;">
