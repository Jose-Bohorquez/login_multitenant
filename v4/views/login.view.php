...
<body class="d-flex justify-content-center align-items-center min-vh-100 bg-light" style="background-image: url('assets/imagenes/Fondo3.webp'); background-size: cover; background-position: center; background-attachment: fixed;">
    ...
    <script>
        ...
        // Verificamos si el parámetro 'log' existe y es igual a 'fail'
        const log = getURLParameter('log');

        if (log === 'fail') {
            Swal.fire({
                title: "Error",
                text: "Los datos no coinciden, si no recuerda su usuario o contraseña, contacte a soporte",
                icon: "error"
            });
        }
    </script>
